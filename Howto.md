...
```bash
git clone git@github.com:up-htmlacademy/sedona.git
```

Адрес в команде нужно заменить на тот, что вы скопировали. Теперь в папке `sedona` лежит ваш проект.
...
git remote add upstream git@github.com:up-htmlacademy/66361-sedona.git
```
